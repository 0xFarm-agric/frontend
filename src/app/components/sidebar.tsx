...
const Sidebar = ({ setSelectedScreen }) => {
  ...
  const getLinkClasses = (screen: string) => {
    return selected === screen
      ? "text-[#3c6454] bg-[#93af1c] rounded-full p-2 shadow-lg" // Apply green highlight and circle with shadow when selected
      : "text-gray-400 hover:text-black"; // Default styling for unselected items
  };

  return (
    <div className="bg-[#F0F4EA]  text-white h-screen w-16 flex flex-col justify-between py-16">
