    ...
    return (
        ...
        <div className="flex flex-col gap-8 bg-gray-50 px-8 py-4">
            ...
            <div className="flex space-x-2 gap-6">
                {/* First card */}
                <div className="w-1/3 w-80  h-full bg-white rounded-lg shadow-md py-4 ">
                    <div className="w-[100px] h-6 mx-4 mb-2 px-4 items-center bg-[#15A34A] flex rounded-[8px]">
                        ...
                        <span className="ml-2 text-xs text-white">Akure</span>
                    </div>
                    <div className="flex   justify-between items-center ">
                        ...
                        <div className="flex flex-col  px-4">
                            <div className="flex items-center mb-2">
                                ...
                                <div className="flex flex-col pr-2">
                                    ...
                                    <p className="text-gray-600 text-[12px]">Aug 12, 2024</p>
                                </div>
                            ...
                            <p className="text-gray-600 text-[12px]">High:27 Low:16</p>
                        </div>
                        ...
                        <div className="flex flex-col text-center pr-4">
                            ...
                            <p className="text-[14px] font-semibold">Cloudy</p>
                            <p className="text-gray-600 text-[12px]">Feels like 26</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Second card */}
                <div className="w-1/3 h-full px-2 bg-white rounded-lg shadow-md">
                    <h2 className="text-sm font-medium mb-2">Production Overview</h2>
                ...
                <div className="flex flex-col space-y-2 w-1/3">
                    ...
                    <div className="w-64 p-4 bg-white rounded-lg shadow-md">
                        ...
                        <p className="text-black font-semibold text-xs">1200 width x 500 height.</p>
                    </div>

                    {/* Fourth card */}
                    <div className="w-64 p-4 bg-white rounded-lg shadow-md">
                        <h2 className="text-[14px] font-medium mb-4">Revenue</h2>
                        <p className="text-black text-xs font-semibold">$5,000</p>
                    </div>
                </div>
            </div>
