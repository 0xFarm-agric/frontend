...
const CommentsSection = () => {
    ...
    const handleReplySubmit = (commentId: number, event:React.FormEvent<HTMLFormElement>) => {
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="mt-2 flex items-center space-x-6">
                                    ...
                                    >
                                        ...
                                        <ChevronDown
                                            className={`w-4 h-4 text-[10px] ml-1 transform transition-transform ${comment.isExpanded ? 'rotate-180' : ''
                                                }`}
                                        />
                                    </button>
                                </div>
