        ...
        <div>
            ...
            <div className="flex justify-spacebetween my-4">
                ...
                <div className="flex space-x-4">
                    {/* First card */}
                    <div className="w-64 flex flex-col justify-between h-64 bg-white rounded-lg shadow-md">
                        {/*First Row: Date and Icon */}
                        <div className="flex items-centermb-4 px-4">
                     
                            <div className="flex flex-col pr-4">
                                <p className="text-sm font-semibold">Monday</p>
                                <p className="text-gray-600 text-[10px]">August 12, 2024</p>
                            </div>
                        ...
                        <div className="p-4 text-white flex items-center justify-center">
                            ...
                            <p className="text-xl font-semibold mb-4">Cloudy</p>
                    ...
                    <div className="w-64 p-4 bg-white rounded-lg shadow-md">
                        <h2 className="text-sm font-semibold mb-4">Production Overview</h2>
                ...
                <div className="flex flex-col space-y-4 mt-4">
                    {/* Third card */}
                    <div className="w-64 p-4 bg-white rounded-lg shadow-md">
                        <h2 className="text-xl font-semibold mb-4">Total Vertical Farm area</h2>
